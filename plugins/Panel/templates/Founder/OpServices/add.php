<?php
$this->assign('title', __d('panel', 'Create operational printing services'));

$this->start('breadcrumbs');
$breadcrumbs = [
    ['title' => __d('panel', 'Operational printing services'), 'url' => ['controller' => 'OpServices', 'action' => 'index']],
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-plus-circle"></i> <?= __d('panel', 'Create operational printing services') ?>
    </h1>
</div>
