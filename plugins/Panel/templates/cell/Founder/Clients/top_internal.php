    ...
    <table class="table table-bordered m-0">
        <thead>
            <tr>
                ...
                <th class="text-right"><?= __d('panel', 'Cost price') ?></th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right">
                    <?= $this->Number->currency($client->total_cost_price, 'UZS'); ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
...
<?php else: ?>
<div class="text-center text-info my-2"><?= __d('panel', 'There are currently no orders from internal clients') ?></div>
<?php endif; ?>