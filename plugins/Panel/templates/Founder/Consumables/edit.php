 ...
 */
$this->assign('title', __d('panel', 'Edit consumable'));

$this->start('breadcrumbs');
$breadcrumbs = [
    ['title' => __d('panel', 'Directory')],
    ['title' => __d('panel', 'Consumables'), 'url' => ['action' => 'index']],
    ['title' => h($consumable->title), 'url' => ['action' => 'view', h($consumable->id)]],
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-pencil"></i> <?= __d('panel', 'Edit consumable') ?>
    </h1>
</div>
                ...
                <div class="panel-content">
                    <div class="row mb-3">
                        <div class="col-lg-6 mb-3 mb-lg-0">
                            <?php
                            echo $this->Form->control('consumable_category_id', [
                                'class' => 'select2',
                                'label' => __d('panel', 'Category') . $this->Html->tag('span' , '*', ['class' => 'ml-1 text-danger']),
                                'escape' => false
                            ]);
                            ?>
                        </div>
                        <div class="col-lg-6 mb-3 mb-lg-0">
                            ...
                            echo $this->Form->control('type', [
                                ...
                                'options' => $this->Consumables->typeList(),
                                'escape' => false
                            ]);
                            ?>
                        </div>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    echo $this->Form->control('unit_id', [
                        'class' => 'select2',
                        'label' => __d('panel', 'Unit'),
                        'empty' => __d('panel', 'Select unit')
                    ]);
                    echo $this->Form->control('quantity', [
                        'label' => __d('panel', 'Quantity')
                    ]);
                    ?>
