...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $laserMachineRate->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $laserMachineRate->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="laserMachineRates form content">
            ...
            <fieldset>
                <legend><?= __('Edit Laser Machine Rate') ?></legend>
                <?php
