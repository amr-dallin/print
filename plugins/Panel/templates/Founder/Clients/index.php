 ...
 * @var iterable<\Cake\Datasource\EntityInterface> $clients
 */
$this->assign('title', $this->Clients->typeList()[$this->request->getParam('pass')[0]] . ' ' . __d('panel', 'clients'));

$this->start('breadcrumbs');
$breadcrumbs = [
    ['title' => __d('panel', 'Orders')],
    ['title' => __d('panel', 'Clients')],
    ['title' => $this->Clients->typeList()[$this->request->getParam('pass')[0]] . ' ' . __d('panel', 'clients')]
];
echo $this->element('breadcrumbs', ['breadcrumbs' => $breadcrumbs]);
$this->end();

$this->start('navigation');
$menu['orders']['clients'][$this->Clients->navigationSlug($this->request->getParam('pass')[0])] = true;
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-table"></i> <?= $this->Clients->typeList()[$this->request->getParam('pass')[0]] . ' ' . __d('panel', 'clients') ?>
    </h1>
</div>
                    ...
                    <table class="table table-bordered table-hover table-striped w-100 datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $client->representative->full_name ?></td>
                                <td>
                                    <?php
                                    echo $this->Html->link(
                                ...
                                <td class="text-center"><?= count($client->orders) ?></td>
                                <td class="text-center">
                                    <?php
                                    echo $this->Html->link(
                                        $this->Html->tag('i', '', ['class' => 'fal fa-eye']),
                                        ['action' => 'view', h($client->id)],
                                        ['escape' => false]
                                    );
                                    ?>
                                </td>
