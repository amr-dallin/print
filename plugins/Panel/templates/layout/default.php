...
<html lang="<?= $this->request->getParam('lang') ?>">
    <head>
        ...
        <?= $this->fetch('meta') ?>
        <!-- base css -->
        <?= $this->Html->css('vendors.bundle', ['media' => 'screen, print', 'fullBase' => true]) ?>
        <?= $this->Html->css('app.bundle', ['media' => 'screen, print', 'fullBase' => true]) ?>
        <?= $this->fetch('css') ?>
                        ...
                        <div class="ml-auto d-flex">
                            ...
                            <div>
                                <a href="#" data-toggle="dropdown" class="header-icon d-flex align-items-center justify-content-center ml-2">
                                    <?= $this->Html->image('avatar-m.png', ['class' => 'profile-image rounded-circle']) ?>
                                </a>
