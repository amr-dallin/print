...
class SystemicPagesController extends AppController
{
    ...
    public function cashRegisterStatistics()
    {
        $opExpense = $this->getTableLocator()->get('OpExpenses')->newEmptyEntity();
        $opReceipt = $this->getTableLocator()->get('OpReceipts')->newEmptyEntity();

        $this->set(compact('opExpense', 'opReceipt'));
    }
}
