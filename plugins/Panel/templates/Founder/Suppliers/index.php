 ...
 * @var iterable<\Cake\Datasource\EntityInterface> $suppliers
 */
$this->assign('title', __d('panel', 'Suppliers'));

$this->start('breadcrumbs');
$breadcrumbs = [
    ['title' => __d('panel', 'Storage')],
    ['title' => __d('panel', 'Suppliers')]
];
echo $this->element('breadcrumbs', ['breadcrumbs' => $breadcrumbs]);
$this->end();

$this->start('navigation');
$menu['storage']['suppliers'] = true;
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-table"></i> <?= __d('panel', 'Suppliers') ?>
    </h1>
</div>
