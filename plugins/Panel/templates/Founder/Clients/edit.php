 ...
 */
$this->assign('title', __d('panel', 'Edit client'));
...
$breadcrumbs = [
    ...
    [
        'title' => $this->Clients->typeList()[h($client->type)] . ' ' . __d('panel', 'clients'),
        'url' => ['action' => 'index', h($client->type)]
    ],
    ['title' => h($client->title), 'url' => ['action' => 'view', h($client->id)]],
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-pencil"></i> <?= __d('panel', 'Edit client') ?>
    </h1>
</div>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    echo $this->Form->control('discount', [
                        'placeholder' => __d('panel', 'Discount')
                    ]);
                    ?>
                </div>
            </div>
