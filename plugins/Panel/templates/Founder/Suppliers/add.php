 ...
 */
$this->assign('title', __d('panel', 'Create supplier'));

$this->start('breadcrumbs');
$breadcrumbs = [
    ['title' => __d('panel', 'Storage')],
    ['title' => __d('panel', 'Suppliers'), 'url' => ['action' => 'index']],
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-plus-circle"></i> <?= __d('panel', 'Create supplier') ?>
    </h1>
</div>
